...
function createConnectionToRedis() {
    const redisInitConfig = {
        ...
        name: Config.redis.set_name,
        sentinelRetryStrategy: getRetryStrategy(),
        retryStrategy: getRetryStrategy(),
    };

    console.log('Init connection to Redis with following data:');
    console.dir(redisInitConfig)

    return new Redis(redisInitConfig)
