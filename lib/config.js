...
const REDIS_SENTINEL_MASTER_NAME = REDIS_SENTINEL_MASTER_SET;

console.log('PROCESSED_REDIS_PORT =', PROCESSED_REDIS_PORT)
console.log('PROCESSED_REDIS_HOST =', PROCESSED_REDIS_HOST)
console.log('REDIS_SENTINEL_MASTER_NAME =', REDIS_SENTINEL_MASTER_NAME)
...
let Config = {
    ...
    redis: {
        ...
        port: 6379,//PROCESSED_REDIS_PORT,
    },
    globalRedisPrefix: '',
